...
import 'package:AgentServe/domain/entities/provider.dart';
...
class AgentServePlatformService {
  final GenerativeModel? _model;
  final bool useGeminiForIntent;

  AgentServePlatformService(
    String apiKey, {
    ...
    this.useGeminiForIntent = true,
           ...
           : GenerativeModel(
               ...
               systemInstruction: Content.system(
                 'You are AgentServe, the core platform for orchestrating agent workflows. Your task is to manage multi-step reasoning, integrate tools, and execute actions.',
               ),
             );
